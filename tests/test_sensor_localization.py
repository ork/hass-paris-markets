...
from custom_components.paris_markets.sensor import MarketSensor
...
class TestMarketSensorLocalization:
    """Test MarketSensor localization and translation features."""
    ...
    def test_sensor_names_for_different_markets(self, mock_coordinator) -> None:
        ...
        sensor1 = MarketSensor(mock_coordinator, "market_1")
        ...
        sensor2 = MarketSensor(mock_coordinator, "market_2")
        ...
        # Bio market
        sensor3 = MarketSensor(mock_coordinator, "market_bio")
    ...
    def test_sensor_fallback_names_for_missing_data(self, empty_coordinator) -> None:
        ...
        sensor = MarketSensor(empty_coordinator, "unknown_market")
...
class TestMarketSensorTimezoneHandling:
    """Test MarketSensor timezone handling and Paris time calculations."""
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (6, "open"),  # 8 AM Paris (6 UTC + 2) - exactly opening time (market opens)
            (7, "open"),  # 9 AM Paris
            (10, "open"),  # 12 PM Paris
            (12, "open"),  # 2 PM Paris - exactly closing time (market still open)
            (13, "closed"),  # 3 PM Paris - after closing
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (7, "open"),  # 8 AM Paris (7 UTC + 1) - exactly opening time (market opens)
            (8, "open"),  # 9 AM Paris
            (11, "open"),  # 12 PM Paris
            (13, "open"),  # 2 PM Paris - exactly closing time (market still open)
            (14, "closed"),  # 3 PM Paris - after closing
        ],
    )
    ...
    def test_different_timezone_inputs(self, mock_coordinator) -> None:
        ...
        for test_time in test_times:
            with patch(
                "custom_components.paris_markets.sensor.datetime"
            ) as mock_datetime:
...
class TestMarketSensorStateTransitions:
    ...
    def test_different_market_schedules(self, mock_coordinator) -> None:
        ...
        with patch("custom_components.paris_markets.sensor.datetime") as mock_datetime:
            ...
            mock_datetime.side_effect = lambda *args, **kw: datetime(*args, **kw)
            assert sensor2.native_value == "open"
        ...
        with patch("custom_components.paris_markets.sensor.datetime") as mock_datetime:
            ...
            mock_datetime.side_effect = lambda *args, **kw: datetime(*args, **kw)
            assert bio_sensor.native_value == "open"
        ...
        with patch("custom_components.paris_markets.sensor.datetime") as mock_datetime:
            ...
            mock_datetime.side_effect = lambda *args, **kw: datetime(*args, **kw)
            assert bio_sensor.native_value == "closed"
